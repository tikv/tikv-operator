...
const (
	skipReasonOrphanPodsCleanerIsNotTarget         = "orphan pods cleaner: member type is not pd, tikv"
...
func (opc *orphanPodsCleaner) Clean(tc *v1alpha1.TikvCluster) (map[string]string, error) {
	ns := tc.GetNamespace()
	// for unit test
